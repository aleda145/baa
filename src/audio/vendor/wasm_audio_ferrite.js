/* @ts-self-types="./wasm_audio_ferrite.d.ts" */
...
export class NoiseReducer {
    ...
    learn_noise(noise_samples) {
        const ptr0 = passArrayF32ToWasm0(noise_samples, wasm.__wbindgen_export);
...
if (Symbol.dispose) NoiseReducer.prototype[Symbol.dispose] = NoiseReducer.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./wasm_audio_ferrite_bg.js": import0,
    };
}

const NoiseReducerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_noisereducer_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = '/wasm/wasm_audio_ferrite_bg.wasm';
    }
    const imports = __wbg_get_imports();
